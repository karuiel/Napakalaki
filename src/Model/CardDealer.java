...
//------------------------------Other methods-----------------------------------
    ...
    */
    private void initMonsterCardDeck(){
        ...
        badConsequence = new SpecificBadConsequence("Embobados con el lindo primigenio te "
        ...
        badConsequence = new NumberBadConsequence("Pierdes todos tus tesoros visibles",0, Integer.MAX_VALUE,0);
        prize = new Prize(3,1);
        ...
        badConsequence = new NumberBadConsequence("Pierdes 5 niveles y 3 tesoros visibles", 5, 3, 0);
        prize = new Prize(4,2);
        unusedMonster.add(new   Monster("El   rey   de   rosa",   13,   badConsequence, prize,0));
        
                
        badConsequence = new NumberBadConsequence("Toses los pulmones y pierdes 2 niveles", 2, 0, 0);
        prize = new Prize(1,1);
        unusedMonster.add(new   Monster("La que redacta en las tinieblas", 2, badConsequence, prize,0));

        
        badConsequence = new DeathBadConsequence("Estos monstruos resultan bastantes superficiales y "
                + "te aburren mortalmente. Estas muerto." , true);
        prize = new Prize(2,1);
        unusedMonster.add(new Monster("Los hondos", 8, badConsequence, prize,0));
        
        
        badConsequence = new NumberBadConsequence("Pierdes dos niveles y dos tesoros ocultos" ,2,
               0,2);
        prize = new Prize(2,1);
        ...
        badConsequence = new NumberBadConsequence("Da mucho asquito. Pierdes 3 niveles" ,3,
                0, 0);
        prize = new Prize(1,1);
        unusedMonster.add(new Monster("Pollipólipo volante", 3, badConsequence, prize,0));
        
        
        badConsequence = new DeathBadConsequence("No le hace gracia que pronuncien mal su nombre."
                + "Estas muerto" ,true);
        prize = new Prize(3,1);
        ...
        badConsequence = new SpecificBadConsequence("La quinta directiva primaria te obliga a perder"
        ...
        badConsequence = new NumberBadConsequence("Menudo susto te llevas. Pierdes "
        ...
        badConsequence = new NumberBadConsequence("Pierdes tus tesoros visibles. Jajaja",0, Integer.MAX_VALUE,0);
        prize = new Prize(2,1);
        ...
        badConsequence = new NumberBadConsequence("Tu gobierno te recorta 2 niveles",2,0,0);
        prize = new Prize(2,1);
        ...
        badConsequence = new NumberBadConsequence("Pierdes 2 niveles",2,0,0);
        prize = new Prize(4,2);
